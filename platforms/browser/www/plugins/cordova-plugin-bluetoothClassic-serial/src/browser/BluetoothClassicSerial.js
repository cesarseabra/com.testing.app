cordova.define("cordova-plugin-bluetoothClassic-serial.BluetoothSerial_browser", function(require, exports, module) { // This implementation is for testing in the brower. Future implemetations *might* be able to use
